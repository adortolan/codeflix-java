package com.codeflixjava.e2e.genre;
...
public class GenreE2ETest {
    ...
    public void asCatalogAdminIShouldBeAbleToCreateANewGenreWithValidValues() throws Exception {
        ...
        final var actualGenre = genreRepository
                .findById(actualId.getValue()).get();
    ...
    public void asCatalogAdminIShouldBeAbleToCreateANewGenreWithCategories() throws Exception {
        ...
        final var series = givenACategory("Séries", null, true);
    ...
    private CategoryID givenAGenre(final String aName, final boolean isActive, List<CategoryID> categories) throws Exception {
