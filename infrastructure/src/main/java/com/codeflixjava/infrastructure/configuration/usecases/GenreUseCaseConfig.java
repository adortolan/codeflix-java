...
import com.codeflixjava.application.genre.create.DefaultCreateGenreUseCase;
import com.codeflixjava.application.genre.delete.DefaultDeleteGenreUseCase;
import com.codeflixjava.application.genre.delete.DeleteGenreUseCase;
import com.codeflixjava.application.genre.retrieve.get.DefaultGetGenreByIdUseCase;
import com.codeflixjava.application.genre.retrieve.get.GetGenreByIdUseCase;
import com.codeflixjava.application.genre.retrieve.list.DefaultListGenreUseCase;
import com.codeflixjava.application.genre.retrieve.list.ListGenreUseCase;
import com.codeflixjava.application.genre.update.DefaultUpdateGenreUseCase;
